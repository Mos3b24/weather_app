...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  // simulate patch: save note locally
  Future<void> patchNote(String note) async {
    setState(() {
      userNote = note; // simulate PATCH
    });
  }
  ...
  Future<Weather> fetchWeather(String city) async {
    ...
    Future <void> Ubdate_country() async {
    ...
    setState(() {
      _result = "the Note has been added: ${response.body}";
    });

  }  

  Future <void> add_city() async {
    final response = await http.post(Uri.parse(
      'http://api.weatherstack.com/current?access_key=73e275f2d88e6aa0d4abb6072082dac2&query=$city'),
      
      body: jsonEncode({
        "country": "New City has been created"
      })
      );
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  ...
                                  onPressed: (){
                                    patchNote(_controllerNote.text);
                                    ...
                                    builder: (context){
                                      return Container (
                                        ...
                                        child: Text("Your note has been added $userNote", textAlign: TextAlign.center,)
                                        );
                                    }
                                    );
                                  },
